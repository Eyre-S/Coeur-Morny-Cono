...
/** TODO: tests for new parser and universal InputCommand API
  */
object Dummy
...
//
//		def Cmd (input: string) = InputCommand.retrieve(input)
//		def Lmd (input: String) = InputCommand.retrieve(input)
//
